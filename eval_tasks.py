...
def run_eval():
    ...
    passed = 0
    for r in results:
        status = "âœ… PASS" if r["success"] else "âŒ FAIL"
    ...
    print(f"\nðŸ“Š TOTAL: {passed}/{len(TASKS)} tasks passed")
    print(f"ðŸ“Š Total tokens consumed: {total_tokens}")
    print(f"ðŸ“Š Total latency: {total_latency}ms ({total_latency/1000:.1f}s)")
